  ...
  return (
    <>
      <div className="container ">
        ...
        <div className="d-flex justify-content-lg-between px-5 pb-0"  style={ {background: '#1113' , borderRadius:' 10px' }}>
          <div className="d-flex text-center flex-column flex">
            <span className="text-center">Feels-Like</span>
            <p className="p-0 m-0  d-flex flex-grow-1" style={{ fontSize: "4em" }}>
              {feels_like}&deg;
            </p>
          </div>
          <img
            onLoad={weatherIcons()}
            src={`${IconLink}`}
            className="mt-1 pt-3 d-flex justify-content-end"
        ...
        <div className="row mt-3"  style={ {background: '#1113' , borderRadius:' 10px' }}>
          <div className=" col-xxl-4 col-xl-4 col-lg-4 col-md-4   col-12   border-end border-info  d-flex flex-column ">
            <div className="d-flex  mt-1  flex-grow-1">
            ...
            <div className="d-flex flex-grow-1">
              <p className=" mt-1  d-flex flex-grow-1 ">
          ...
          <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4   col-12 d-flex mt-1 flex-column border-end ">
            <div className="d-flex flex-grow-1">
          ...
          <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4   col-12 d-flex mt-1 flex-column  ">
            <div className="d-flex flex-grow-1">
            ...
            <div className="d-flex flex-grow-1">
              ...
              <p className=""> {visiblity /1000} km </p>
            </div>
            <div className="d-flex flex-grow-1">
              <p className=" mt-1  d-flex flex-grow-1 " id="logo">
                <span className=" " id="SeaLevelIcon">
